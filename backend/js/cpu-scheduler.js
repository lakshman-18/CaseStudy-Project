	...
	function run() {
		...
		if (processArray.length > 0) {
			...
			if (algorithm == "Priority") {
				...
				$("#algorithm_explanation").text("Deadline Scheduling will execute each process according to the assigned deadline number. In this case a lower deadline number is the higher the priority is.");
				priority();
				processTotal = processArray;
			}
